...
class tx_party_model_basic_testcase extends tx_t3unit_testcase {
	...
	public function __construct($name) {
		$this->fixture = tx_div2007::makeInstance('tx_party_tests_fixture');
	...
	public function test_readPerson_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_person');
		$object->load(12);
	...
	public function test_readOrganisation_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_organisation');
		$object->load(1);
	...
	public function test_readPersonName_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_personname');
		$object->load(12);
		self::assertSame($object->get('last_name'),'Omini');
	...
	public function test_readOrganisationName_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_organisationname');
		$object->load(1);
		self::assertSame($object->get('organisation_name'),'Newton Mearns Church');
	...
	public function test_readAddress_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_address');
		$object->load(1578);
		self::assertSame($object->get('locality'),'Vendlincourt');
	...
	public function test_readElectronicAddressIdentifier_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_electronicaddressidentifier');
		$object->load(1);
		self::assertSame($object->get('electronic_address_identifier'),'info@newton-mearns-church.com');
	...
	public function test_readAccount_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_account');
		$object->load(6);
	...
	public function test_readAllergy_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_allergy');
		$object->load(1);
	...
	public function test_readContact_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_contact');
		$object->load(808);
	...
	public function test_readCountryOfResidence_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_countryofresidence');
		$object->load(1113);
	...
	public function test_readDisability_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_disability');
		$object->load(24);
	...
	public function test_readDocument_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_document');
		$object->load(1417);
	...
	public function test_readEthnicity_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_ethnicity');
		$object->load(11);
	...
	public function test_readEvent_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_event');
		$object->load(937);
	...
	public function test_readFavourite_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_favourite');
		$object->load(153);
	...
	public function test_readHabit_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_habit');
		$object->load(1);
	...
	public function test_readHobby_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_hobby');
		$object->load(24);
	...
	public function test_readIdentifier_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_identifier');
		$object->load(250);
	...
	public function test_readImage_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_image');
		$object->load(1);
	...
	public function test_readLanguage_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_language');
		$object->load(120);
	...
	public function test_readMark_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_mark');
		$object->load(1);
	...
	public function test_readMembership_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_membership');
		$object->load(1);
	...
	public function test_readNationality_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_nationality');
		$object->load(3);
	...
	public function test_readOccupationRank_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_occupationrank');
		$object->load(1);
	...
	public function test_readOccupationRole_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_occupationrole');
		$object->load(1);
	...
	public function test_readOccupation_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_occupation');
		$object->load(1);
	...
	public function test_readOrganisationNature_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_organisationnature');
		$object->load(3);
	...
	public function test_readPersonNameTitle_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_personnametitle');
		$object->load(2);
	...
	public function test_readPhysicalStatus_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_physicalstatus');
		$object->load(1);
	...
	public function test_readPreference_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_preference');
		$object->load(2);
	...
	public function test_readQualificationStatus_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_qualificationstatus');
		$object->load(2);
	...
	public function test_readQualification_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_qualification');
		$object->load(6);
	...
	public function test_readRelationshipType_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_relationshiptype');
		$object->load(1);
	...
	public function test_readRelationship_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_relationship');
		$object->load(1);
	...
	public function test_readReligion_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_religion');
		$object->load(1);
	...
	public function test_readRevenue_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_revenue');
		$object->load(214);
	...
	public function test_readStockMarket_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_stockmarket');
		$object->load(3);
	...
	public function test_readUsage_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_usage');
		$object->load(1);
	...
	public function test_readVehicleManufacturer_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_vehiclemanufacturer');
		$object->load(1);
	...
	public function test_readVehicle_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_vehicle');
		$object->load(4);
	...
	public function test_readVisa_basic() {
		$object = tx_div2007::makeInstance('tx_party_models_visa');
		$object->load(1);
...
/*
	public function test_exportFixture() {
		$fixture = tx_div2007::makeInstance('tx_party_tests_fixture');
		$fixture->export(13);
	}
*/
