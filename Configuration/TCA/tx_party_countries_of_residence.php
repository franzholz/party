    ...
    'columns' => [
        ...
        'residency_type' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => "AND tx_party_types.allowed_for_field LIKE '%tx_party_COUNTRIES_OF_RESIDENCE-RESIDENCY_TYPE%' AND tx_party_types.pid=###PAGE_TSCONFIG_ID### ORDER BY tx_party_types.uid",
                'size' => 1,
                'minitems' => 0,
                'maxitems' => 1,
                'default' => 0,
