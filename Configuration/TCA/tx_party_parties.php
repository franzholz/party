    ...
    'columns' => [
        ...
        'religion' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_party_religions.pid=###PAGE_TSCONFIG_ID### ORDER BY tx_party_religions.uid',
                'size' => 1,
                'minitems' => 0,
                'maxitems' => 1,
                'default' => 0,
        ...
        'physical_status' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_party_physical_status.pid=###PAGE_TSCONFIG_ID### ORDER BY tx_party_physical_status.uid',
                'size' => 1,
                'minitems' => 0,
                'maxitems' => 1,
                'default' => 0,
        ...
        'ethnicity' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_party_ethnicities.pid=###PAGE_TSCONFIG_ID### ORDER BY tx_party_ethnicities.uid',
                'size' => 1,
                'minitems' => 0,
                'maxitems' => 1,
                'default' => 0,
        ...
        'hobbies' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_party_hobbies.pid=###PAGE_TSCONFIG_ID### ORDER BY tx_party_hobbies.uid',
                'size' => 5,
                'autoSizeMax' => 20,
                'minitems' => 0,
                'maxitems' => 99,
        ...
        'habits' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_party_habits.pid=###PAGE_TSCONFIG_ID### ORDER BY tx_party_habits.uid',
                'size' => 5,
                'autoSizeMax' => 20,
                'minitems' => 0,
                'maxitems' => 99,
        ...
        'organisation_type' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => "AND tx_party_types.allowed_for_field LIKE '%tx_party_ORGANISATIONS-ORGANISATION_TYPE%' AND tx_party_types.pid=###PAGE_TSCONFIG_ID### ORDER BY tx_party_types.uid",
                'size' => 1,
                'minitems' => 0,
                'maxitems' => 1,
                'default' => 0,
        ...
        'organisation_nature' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_party_organisation_natures.pid=###PAGE_TSCONFIG_ID### ORDER BY tx_party_organisation_natures.uid',
                'size' => 1,
                'minitems' => 0,
                'maxitems' => 1,
                'default' => 0,
        ...
        'electronic_address_identifiers' => [
            ...
            'config' => [
                ...
                'foreign_unique' => 'electronic_address_identifier',
                'maxitems' => 99,
                'appearance' => $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['party']['inline_appearance']['combined'],
                'default' => '',
            ],
        ...
        'allergies' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_party_allergies.pid=###PAGE_TSCONFIG_ID### ORDER BY tx_party_allergies.uid',
                'size' => 5,
                'autoSizeMax' => 20,
                'minitems' => 0,
                'maxitems' => 99,
