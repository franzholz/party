...
/**
 * Static utility functions for the Party Management Framework.
 *
 * The functions can only be used se non-instantiated, e.g.
 * tx_party_div::getAllTypeFields()
 *
 *
 * $Id: class.tx_party_div.php 81705 2013-11-23 10:37:30Z franzholz $
 *
...
class tx_party_div {
	...
	/**
	 * Returns a comma-separated list with all relevant fields of the table, according to the
	 * 'type' of the record.
	 *
	 * Based on BackendUtility::getTCAtypes(). Problems with the core-function:
	...
	static public function getAllTypeFields ($table, $rec) {
		...
		// Add 'common fields'
		$result = 'uid,pid,tstamp,crdate,cruser_id,deleted,';

		// Get all type fields with the core function.
		$typeFields = BackendUtility::getTCAtypes($table, $rec, TRUE);
