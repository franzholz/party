 ...
 *
 * $Id: class.tx_party_models_electronicaddressidentifier.php 81705 2013-11-23 10:37:30Z franzholz $
 *
...
class ElectronicAddressIdentifier extends AbstractObject {
	 ...
	 * @var	string
	 */
	static protected $tableName = 'tx_party_electronic_address_identifiers';
	...
	public function getLabel () {
		...
		$result = $this->getElectronicAddressIdentifier();
		return $result;
	}
}
