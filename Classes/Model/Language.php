 ...
 *
 * $Id: class.tx_party_models_language.php 81705 2013-11-23 10:37:30Z franzholz $
 *
...
class Language extends AbstractObject {
	 ...
	 * @var	string
	 */
	static protected $tableName = 'tx_party_languages';
	...
	protected $fieldToObjectMap = array(
		...
		'language' => 'JambageCom\\Party\\Model\\Foreign\\StaticLanguage',
	...
	public function getLabel () {
		...
		$languageText = $language->getLgNameEn();

		// Assemble the label
		$label[0] = $languageText;
		if ($party->hasRecord()) {
