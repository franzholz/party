 ...
 *
 * $Id: class.tx_party_models_stockmarket.php 81705 2013-11-23 10:37:30Z franzholz $
 *
...
class StockMarket extends AbstractObject {
	 ...
	 * @var	string
	 */
	static protected $tableName = 'tx_party_stock_markets';
	...
	protected $fieldToObjectMap = array(
		...
		'market' => 'JambageCom\\Party\\Model\\Foreign\\StaticMarket',
	);
	...
	public function getLabel () {
		...
		$listedCode = $this->getListedCode();
		$market = $this->getMarket();  // Todo: 'institution_description';
		$party = $this->getParty();
