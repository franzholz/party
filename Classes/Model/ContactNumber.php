...
/**
 * Model for the class ContactNumber
 *
...
class ContactNumber extends AbstractObject {
	 ...
	 * @var	string
	 */
	static protected $tableName = 'tx_party_contact_numbers';
	...
	protected $fieldToObjectMap = array(
		...
		'country' => 'JambageCom\\Party\\Model\\Type',
	);
}
