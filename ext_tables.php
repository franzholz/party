...
$TCA["tx_party_birth_signs"] = array (
	"ctrl" => array (
		...
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_birth_signs.gif',
	),
	"feInterface" => array (
...
$TCA["tx_party_birth_stars"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_birth_stars.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "sys_language_uid, l18n_parent, l18n_diffsource, short_title, title, long_title",
	)
...
$TCA["tx_party_ethnicities"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_ethnicities.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "sys_language_uid, l18n_parent, l18n_diffsource, short_title, title, long_title",
	)
...
$TCA["tx_party_habits"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_habits.gif',
	),
	"feInterface" => array (
...
$TCA["tx_party_hobbies"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_hobbies.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "sys_language_uid, l18n_parent, l18n_diffsource, short_title, title, long_title",
	)
...
$TCA["tx_party_occupation_ranks"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_occupation_ranks.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "sys_language_uid, l18n_parent, l18n_diffsource, short_title, title, long_title",
	)
...
$TCA["tx_party_occupation_roles"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_occupation_roles.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "sys_language_uid, l18n_parent, l18n_diffsource, short_title, title, long_title",
	)
...
$TCA["tx_party_organisation_natures"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_organisation_natures.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "sys_language_uid, l18n_parent, l18n_diffsource, short_title, title, long_title",
	)
...
$TCA["tx_party_person_name_titles"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_person_name_titles.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "sys_language_uid, l18n_parent, l18n_diffsource, short_title, title, long_title",
	)
...
$TCA["tx_party_physical_status"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_physical_status.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "sys_language_uid, l18n_parent, l18n_diffsource, short_title, title, long_title",
	)
...
$TCA["tx_party_qualification_status"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_qualification_status.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "sys_language_uid, l18n_parent, l18n_diffsource, short_title, title, long_title",
	)
...
$TCA["tx_party_religions"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_religions.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "sys_language_uid, l18n_parent, l18n_diffsource, short_title, title, long_title",
	)
...
$TCA["tx_party_types"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_types.gif',
	),
	"feInterface" => array (
...
$TCA["tx_party_vehicle_manufacturer"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_vehicle_manufacturer.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "sys_language_uid, l18n_parent, l18n_diffsource, short_title, title, long_title",
	)
...
$TCA["tx_party_accounts"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_accounts.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "ownership_type, account_id, issuing_authority, account_type, remarks, organisation",
	)
);
...
$TCA["tx_party_contacts"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_contacts.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "type, contact, remarks",
	)
);
...
$TCA["tx_party_contact_numbers"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_contact_numbers.gif',
	),
	"feInterface" => array (
...
$TCA["tx_party_countries_of_residence"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_countries_of_residence.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "country, residency_type, remarks",
	)
);
...
$TCA["tx_party_disabilities"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_disabilities.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "disability, cause, remarks",
	)
);
...
$TCA["tx_party_documents"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_documents.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "document_type, document_id, issued_by, issue_place, privilege, restriction, group_name, name_on_document, remarks",
	)
);

$TCA["tx_party_eletronic_address_identifiers"] = array (
	"ctrl" => array (
		'title'     => 'LLL:EXT:party/locallang_db.xml:tx_party_eletronic_address_identifiers',		
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_eletronic_address_identifiers.gif',
	),
	"feInterface" => array (
...
$TCA["tx_party_images"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_images.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "image, title, description, remarks",
	)
);
...
$TCA["tx_party_languages"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_languages.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "language, type, read_skills, write_skills, listen_skills, speak_skills, preference, remarks",
	)
);
...
$TCA["tx_party_marks"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_marks.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "mark, body_part, body_part_mark_location, remarks",
	)
);
...
$TCA["tx_party_nationalities"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_nationalities.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "country, nationality_type, remarks",
	)
);
...
$TCA["tx_party_occupations"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_occupations.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "role, rank, employment_type, position_title, cost_centre, reports_to, remarks",
	)
);
...
$TCA["tx_party_names"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_names.gif',
	),
	"feInterface" => array (
...
$TCA["tx_party_qualifications"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_qualifications.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "qualification_name, status, institution, start_date, completion_date, way_of_study, major_subject, minor_subject, mark, course_duration, award, restriction, registration, remarks",
	)
);
...
$TCA["tx_party_relationship_types"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_relationship_types.gif',
	),
	"feInterface" => array (
...
$TCA["tx_party_revenues"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_revenues.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "currency, amount, amount_precision, after_tax, type, period_from, period_to, source, remarks",
	)
);
...
$TCA["tx_party_stock_markets"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_stock_markets.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "market, listed_code, remarks",
	)
);
...
$TCA["tx_party_vehicles"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_vehicles.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "make, type, model, license_place, manufacture_date, engine_number, chassis_number, body_number, remarks",
	)
);
...
$TCA["tx_party_visas"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_visas.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "country, number, code, issue_date, issue_place, maximum_stay, restriction, privilege, special_condition, remarks",
	)
);
...
$TCA["tx_party_events"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_events.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "type, date, date_from, date_to, remarks",
	)
);
...
$TCA["tx_party_identifiers"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_identifiers.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "type, identifier, issue_date, expiry_date, remarks",
	)
);
...
$TCA["tx_party_memberships"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_memberships.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "type, organisation, issue_date, expiry_date, remarks",
	)
);
...
$TCA["tx_party_allergies"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_allergies.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "short_title, title, long_title",
	)
...
$TCA["tx_party_favourites"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_favourites.gif',
	),
	"feInterface" => array (
		"fe_admin_fieldList" => "type, favourite, remarks",
	)
);
...
$TCA["tx_party_preferences"] = array (
	"ctrl" => array (
		...
		'delete' => 'deleted',	
		'dynamicConfigFile' => t3lib_extMgm::extPath($_EXTKEY).'tca.php',
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_party_preferences.gif',
	),
	"feInterface" => array (
