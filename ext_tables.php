...
$TCA['tx_party_occupation_ranks'] = array (
	'ctrl' => array (
		...
		'delete' => 'deleted',
		'dynamicConfigFile' => PATH_BE_PARTY . 'tca.php',
		'iconfile'          => PATH_BE_PARTY_REL . 'icons/icon_tx_party_occupation_ranks.gif',
	),
	'feInterface' => array (
		'fe_admin_fieldList' => 'sys_language_uid, l18n_parent, l18n_diffsource, short_title, title, long_title',
	)
...
$TCA['tx_party_occupation_roles'] = array (
	'ctrl' => array (
		...
		'delete' => 'deleted',
		'dynamicConfigFile' => PATH_BE_PARTY . 'tca.php',
		'iconfile'          => PATH_BE_PARTY_REL . 'icons/icon_tx_party_occupation_roles.gif',
	),
	'feInterface' => array (
		'fe_admin_fieldList' => 'sys_language_uid, l18n_parent, l18n_diffsource, short_title, title, long_title',
	)
...
$TCA['tx_party_parties'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'type, marital_status, religion_id, birth_place, birth_date_time, birth_date_time_precision, ' .
			'birth_sign_id, birth_star, weight, height, breast, waist, hip, hair_colour, eye_colour, skin_colour, ' .
			'blood_group, physical_status_id, ethnicity_id, gender, hobby_id, habit_id, organisation_type_id, organisation_nature_id,' .
			'company_registration_identifier, company_registration_date, number_of_employees, remarks, name_id, address_id, account_id,' .
			'contact_number_id, country_of_residence_id, document_id, electronic_address_identifier_id, image_id, nationality_id, ' .
			'relationship_id, revenue_id, vehicle_id, contact_id, visa_id, disability_id, language_id, mark_id, occupation_id, ' .
			'qualification_id, stock_market_id, event_id, identifier_id, membership_id, allergy_id, favourite_id, preference_id',
	)
);
...
$TCA['tx_party_person_name_titles'] = array (
	'ctrl' => array (
		...
		'delete' => 'deleted',
		'dynamicConfigFile' => PATH_BE_PARTY . 'tca.php',
		'iconfile'          => PATH_BE_PARTY_REL . 'icons/icon_tx_party_person_name_titles.gif',
	),
	'feInterface' => array (
		'fe_admin_fieldList' => 'sys_language_uid, l18n_parent, l18n_diffsource, short_title, title, long_title',
	)
...
$TCA['tx_party_accounts'] = array (
	'ctrl' => array (
		...
		'crdate'    => 'crdate',
		'cruser_id' => 'cruser_id',
		'default_sortby' => 'ORDER BY account_no',
		'delete' => 'deleted',
		'dynamicConfigFile' => PATH_BE_PARTY . 'tca.php',
		'iconfile'          => PATH_BE_PARTY_REL . 'icons/icon_tx_party_accounts.gif',
	),
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, ownership_type_id, account_no, issuing_authority, account_type_id, remarks, organisation_id',
	)
);
...
$TCA['tx_party_contacts'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, type, contact, remarks',
	)
);
...
$TCA['tx_party_contact_numbers'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'media_type, country_id, area_code, local_number, extension, pin, contact_hours, remarks',
	)
);
...
$TCA['tx_party_countries_of_residence'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, country_id, residency_type_id, remarks',
	)
);
...
$TCA['tx_party_disabilities'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, disability, cause, remarks',
	)
);
...
$TCA['tx_party_documents'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, document_type_id, document_no, issued_by, issue_place, privilege, restriction, group_name, name_on_document, remarks',
	)
);
...
$TCA['tx_party_electronic_address_identifiers'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'type_id, electronic_address_identifier, remarks',
	)
);
...
$TCA['tx_party_images'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, address_id, image, title, description, remarks',
	)
);
...
$TCA['tx_party_languages'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, language_id, type, read_skills, write_skills, listen_skills, speak_skills, preference, remarks',
	)
);
...
$TCA['tx_party_marks'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, mark, body_part, body_part_mark_location, remarks',
	)
);
...
$TCA['tx_party_nationalities'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, country, nationality_type, remarks',
	)
);
...
$TCA['tx_party_occupations'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, role, rank, employment_type, position_title, cost_centre, reports_to, remarks',
	)
);
...
$TCA['tx_party_names'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, type_id, person_name_title_id, first_name, middle_name, ancestor_name, last_name, other_name, preceding_title, alias, generation_identifier, place_name, organisation_name_type, organisation_name, abbreviation, remarks',
	)
);
...
$TCA['tx_party_qualifications'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, qualification_name, status_id, institution_id, start_date, completion_date, way_of_study, major_subject, minor_subject, mark, course_duration, award, restriction, registration, remarks',
	)
);
...
$TCA['tx_party_revenues'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, currency_id, amount, amount_precision, after_tax, type_id, period_from, period_to, source, remarks',
	)
);
...
$TCA['tx_party_stock_markets'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, market, listed_code, remarks',
	)
);
...
$TCA['tx_party_vehicles'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, make_id, type_id, model, license_plate, manufacture_date, engine_number, chassis_number, body_number, remarks',
	)
);
...
$TCA['tx_party_visas'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, country, number, code, issue_date, issue_place, maximum_stay, restriction, privilege, special_condition, remarks',
	)
);
...
$TCA['tx_party_events'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, type_id, date, date_from, date_to, remarks',
	)
);
...
$TCA['tx_party_identifiers'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, type, identifier, issue_date, expiry_date, remarks',
	)
);
...
$TCA['tx_party_memberships'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, type_id, organisation_id, issue_date, expiry_date, remarks',
	)
);
...
$TCA['tx_party_favourites'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, type_id, favourite, remarks',
	)
);
...
$TCA['tx_party_preferences'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, type_id, preference, remarks',
	)
);
...
$TCA['tx_party_address_usages'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, address_id, address_usage_id, standard',
	)
);
...
$TCA['tx_party_contact_number_usages'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, contact_number_id, contact_number_usage_id, standard',
	)
);
...
$TCA['tx_party_electronic_address_identifier_usages'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'party_id, electronic_address_identifier_id, electronic_address_identifier_usage_id, standard',
	)
);
...
$TCA['tx_party_relationships'] = array (
	...
	'feInterface' => array (
		'fe_admin_fieldList' => 'primary_party_id, secondary_party_id, relationship_type_id, date_established, date_lapsed, reason_lapsed, remarks',
	)
);
...
foreach ($tableArray as $theTable) {
	if (t3lib_extMgm::isLoaded('simplemvc')) {
