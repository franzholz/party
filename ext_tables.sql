...
CREATE TABLE tx_party_accounts (
	...
	party_id int(11) DEFAULT '0' NOT NULL,
	organisation_id int(11) DEFAULT '0' NOT NULL,
	ownership_type_id int(11) DEFAULT '0' NOT NULL,
	account_no varchar(30) DEFAULT '' NOT NULL,
...
CREATE TABLE tx_party_address_usages (
	...
	address_usage_id int(11) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_party_addresses (
	...
	premise_type_id int(11) DEFAULT '0' NOT NULL,
	...
	administrative_area_id int(11) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_party_contact_number_usages (
	...
	deleted tinyint(4) DEFAULT '0' NOT NULL,
	party_id int(11) DEFAULT '0' NOT NULL,
	contact_number_id int(11) DEFAULT '0' NOT NULL,
	contact_number_usage_id int(11) DEFAULT '0' NOT NULL,
	standard tinyint(3) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_party_countries_of_residence (
	...
	party_id int(11) DEFAULT '0' NOT NULL,
	country_id int(11) DEFAULT '0' NOT NULL,
	residency_type_id int(11) DEFAULT '0' NOT NULL,
	remarks text NOT NULL,
...
CREATE TABLE tx_party_documents (
	...
	deleted tinyint(4) DEFAULT '0' NOT NULL,
	party_id int(11) DEFAULT '0' NOT NULL,
	document_type_id int(11) DEFAULT '0' NOT NULL,
	document_no varchar(90) DEFAULT '' NOT NULL,
	issued_by_id int(11) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_party_electronic_address_identifier_usages (
	...
	deleted tinyint(4) DEFAULT '0' NOT NULL,
	party_id int(11) DEFAULT '0' NOT NULL,
	electronic_address_identifier_id int(11) DEFAULT '0' NOT NULL,
	electronic_address_identifier_usage_id int(11) DEFAULT '0' NOT NULL,
	standard tinyint(3) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_party_names (
	...
	type int(11) DEFAULT '0' NOT NULL,
	standard tinyint(3) DEFAULT '0' NOT NULL,
	person_name_title_id int(11) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_party_nationalities (
	...
	party_id int(11) DEFAULT '0' NOT NULL,
	country_id int(11) DEFAULT '0' NOT NULL,
	nationality_type_id int(11) DEFAULT '0' NOT NULL,
	remarks text NOT NULL,
...
CREATE TABLE tx_party_occupations (
	...
	rank_id int(11) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_party_parties (
	...
	religion_id int(11) DEFAULT '0' NOT NULL,
	...
	birth_sign_id int(11) DEFAULT '0' NOT NULL,
	...
	physical_status_id int(11) DEFAULT '0' NOT NULL,
	ethnicity_id int(11) DEFAULT '0' NOT NULL,
	gender int(11) DEFAULT '0' NOT NULL,
	hobby_id int(11) DEFAULT '0' NOT NULL,
	habit_id int(11) DEFAULT '0' NOT NULL,
	organisation_type_id int(11) DEFAULT '0' NOT NULL,
	organisation_nature_id int(11) DEFAULT '0' NOT NULL,
	company_registration_identifier varchar(90) DEFAULT '' NOT NULL,
	company_registration_date int(11) DEFAULT '0' NOT NULL,
	number_of_employees int(11) DEFAULT '0' NOT NULL,
	remarks text NOT NULL,
	name_id tinytext NOT NULL,
	address_id tinytext NOT NULL,
	account_id tinytext NOT NULL,
	contact_number_id tinytext NOT NULL,
	country_of_residence_id tinytext NOT NULL,
	document_id tinytext NOT NULL,
	electronic_address_identifier_id tinytext NOT NULL,
	image_id tinytext NOT NULL,
	nationality_id tinytext NOT NULL,
	relationship_id tinytext NOT NULL,
	revenue_id tinytext NOT NULL,
	vehicle_id tinytext NOT NULL,
	contact_id tinytext NOT NULL,
	visa_id tinytext NOT NULL,
	disability_id tinytext NOT NULL,
	language_id tinytext NOT NULL,
	mark_id tinytext NOT NULL,
	occupation_id tinytext NOT NULL,
	qualification_id tinytext NOT NULL,
	stock_market_id tinytext NOT NULL,
	event_id tinytext NOT NULL,
	identifier_id tinytext NOT NULL,
	membership_id tinytext NOT NULL,
	allergy_id int(11) DEFAULT '0' NOT NULL,
	favourite_id tinytext NOT NULL,
	preference_id tinytext NOT NULL,
...
#
# Table structure for table 'tx_party_parties_mm_allergies'
#
#
CREATE TABLE tx_party_parties_mm_allergies (
...
#
# Table structure for table 'tx_party_parties_mm_habits'
#
#
CREATE TABLE tx_party_parties_mm_habits (
  uid_local int(11) DEFAULT '0' NOT NULL,
  uid_foreign int(11) DEFAULT '0' NOT NULL,
  tablenames varchar(30) DEFAULT '' NOT NULL,
  sorting int(11) DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_party_parties_mm_hobbies'
#
#
CREATE TABLE tx_party_parties_mm_hobbies (
  uid_local int(11) DEFAULT '0' NOT NULL,
  uid_foreign int(11) DEFAULT '0' NOT NULL,
  tablenames varchar(30) DEFAULT '' NOT NULL,
  sorting int(11) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_party_qualifications (
	...
	institution_id int(11) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_party_relationships (
	...
	cruser_id int(11) DEFAULT '0' NOT NULL,
	deleted tinyint(4) DEFAULT '0' NOT NULL,
	primary_party_id int(11) DEFAULT '0' NOT NULL,
	secondary_party_id int(11) DEFAULT '0' NOT NULL,
	relationship_type_id int(11) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_party_revenues (
	...
	deleted tinyint(4) DEFAULT '0' NOT NULL,
	party_id int(11) DEFAULT '0' NOT NULL,
	currency_id int(11) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_party_stock_markets (
	...
	deleted tinyint(4) DEFAULT '0' NOT NULL,
	party_id int(11) DEFAULT '0' NOT NULL,
	market_id int(11) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_party_vehicles (
	...
	deleted tinyint(4) DEFAULT '0' NOT NULL,
	party_id int(11) DEFAULT '0' NOT NULL,
	make_id int(11) DEFAULT '0' NOT NULL,
	type_id int(11) DEFAULT '0' NOT NULL,
